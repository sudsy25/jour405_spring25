...
I would classify the average range between 5 and 15.  There are some spikes above 20 and some around 1-2 that really stand out.
...
The normal range was a little different, with some of the higher spikes being more normal than unusual.  There were only 11 days that went above average and 7 that went below.
...
The busiest day compared to a typical Tuesday was October 4, 2022, when overdose calls hit 23, more than twice the usual number for that day of the week. It was an extreme spike well above what’s normally seen on a Tuesday in Baltimore County.
...
Our analysis found several days when overdose-related 911 calls were far above normal, especially October 4, 2022, which had more than twice as many calls as usual. These spikes might be tied to bad drug batches, local events, or gaps in prevention efforts. I would talk to first responders and public health officials to learn what happened on those days. This could lead to a strong story about overdose trends and how the community is responding.
