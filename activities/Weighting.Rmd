...
.23 is overrepresented (llower weight), 3.04 is overrepresented (higher weight)

3. Why might some respondents be weighted more heavily than others?

Depends on the percentage of groups that participated in the vote.
...
Rarely/never: the "Yes" category dropped  by -3.6 percentage points after weighting.  No and Unsure increased

2. How might these differences affect reporting on likely voter turnout?

Without waiting, someone may report that rarely voting Americans are actually more likely to turn out than they actually are. This would lead to inaccurate journalism.  Weighted data would give a more realistic picture.
...
Some groups, like people who rarely vote, may not take surveys as often as other groups do. Without weighting, we make sure that the survey really reflects the people.
