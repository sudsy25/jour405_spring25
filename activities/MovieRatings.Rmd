...
5 stars is lower than expected (145 vs 160)
4 stars is higher than expected (128 vs. 120)
3 stars is lower than expected (73 vs. 80)
2 stars and 1 star are both higher than expected (32 vs. 20, 22 vs. 20)
...
9.95 > 9.49 and p <.05, so we reject the null hypothesis, so the distribution is significantly different than expected.
