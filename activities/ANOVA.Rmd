...
Private colleges had the highest average SAT score (1435), followed by public (1360) and community colleges (1068).  Colleges also has the lowest sd (87) meaning they were the most consistent.
...
Yes, they found a highly significant differencein SAT scores between the three.

2. Which specific college types differ from each other?

Private is 74 points higher than public, Public is 292 points above Community, so Private is about 367 points above Community

3. How large are these differences?

The difference between Private and Public is relatively small, but they both clear Community by far.  70 points is honestly not that small in terms of the SAT.
...
Headline: "Private colleges lead in SAT scores, community college fall far behind, data says"

Lead: "Private colleges admit students with the highest SAT scores, averaging 370 points higher than community college.  According to data, public colleges fall 70 points behind Private college as well, but are still significantly higher than community college.
