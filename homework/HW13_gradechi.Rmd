...
The grade distribution could be meaningful, as more A's occured than C's and F's.
...
11.7 > 9.5, so we reject null hypothesis.
...
The grade distribution is significantly different than the expected distribution. Like I said before, A grades are the most different, higher than expected.  I would ask if there have been professor changes or TA changes.  Also the addition of curves or if the student demographic changed (number of freshman, sophomores, juniors, etc)
