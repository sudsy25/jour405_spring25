...
Summerfield has the highest, and this is because it has the highest percentage of a single race (Black) than any other city.
...
They have the most equal Hispanic and non-Hispanic  populations.
...
The top 3 diverse cities are Langley Park, Wheaton, and Adelphi.  They all fall around the D.C. area.  Lake Shore is the least diverse, and it along the west coast of the Chesapeake near Annapolis and the Bay Bridge.
...
Header: The Most Diverse Places in Maryland Are Just Outside D.C.

Lede: In the Maryland suburbs of Washington, D.C., it’s more likely than not that any two people you pass on the street will come from different racial or ethnic backgrounds.

I would interview local residents about the diversity of their neighborhoods, ask school officials about diversity in classes (languages spoken and if they have programs to help different students), and possibly go to Lake Shore and ask diversity questions there.
