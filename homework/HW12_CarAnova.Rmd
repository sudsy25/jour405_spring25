...
The spike year (2023) had the highest average car theft rate (60 per 100,000). Post spike is lower than spike, but still higher than pre-spike.  Suggests that theft rates are still elevated since the spike.
...
This chart shows the spike and the slight decline in car thefts after the spike.

Better title: "2023 Car theft spike leave's PG County thefts high"
...
- **Null Hypothesis (H0)**: No difference in car rates between periods

- **Alternative Hypothesis (H1)**: At least one time period is significantly different than the others
...
We can reject the null hypothesis, so there are significant differences in time periods. p value is way below .05.  Time period does affect car theft rates.
...
Spike is about 17 points higher than Post-spike and 37 above Pre-spike.  Post is 20 points above Pre, so the difference is real and significant.

Headline: "Car thefts in PG county remain elevated Post 2023 spike"

Lead: Car thefts in PG county had a major spike in 2023 and they haven't returned to the level they were before.  Post-spike rates show a 20 point difference between them and Pre-spike rates, according to data.
