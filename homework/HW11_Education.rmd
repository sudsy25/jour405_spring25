...
People with more education are more likely to take surveys.  Less educated people might be less trusting or harder to reach.
...
College grads are most likely to vote, voting intention drops as education drops, data says
...
High school had the biggest drop in their "Yes" intention.  College stayed relatively the same, while some college's "Yes" category dropping slightly.

2. Why might the weighted results be considered more accurate than the unweighted results?

ANSWER HERE

Weighted are more accurate, as they balance groups who are over- and underrepresented.
...
The High school group shows the biggest changes. Their “Yes” vote percentage dropped by 2.7, and “Unsure” increased by 1.3 after weighting.
...
Yes, it makes it slightly easier to see.  You can see the drop more clearly in the High school section.
...
The analysis shows education and voting intention are strongly connected.  People with college degrees are more likely to say they plan to vote, 93% saying yes.  High school or less people had the lowest intention at 71% post-weighting.
...
Polls can be misleading if we don't represent the actual population.

2. How might the differences between weighted and unweighted results affect how you would report on this data?

I'd make sure to first say if polls were weighted so people know.  Second, I wouldn't say a group had a high/low turnout until i know if they were actually weighted that way.
...
I would want to know what other variables were used, such as race, age, gender, and more.  I also want to know where the data comes from, whether it's from the Census or something else.
